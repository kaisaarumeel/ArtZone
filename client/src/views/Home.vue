<template>
  <div class="home-page">
    ...
    <b-row class="about-us mt-4 align-items-center" id="aboutUsSection">
      ...
      <b-col class="text-container pr-5 pt-5" cols="12" lg="8" md="6"><h2 class="text-right">About us</h2><p>At Artzone, we believe that art is more than just paint on canvas or sculptures in a gallery; it's a powerful form of expression that connects individuals and cultures worldwide. Our mission is to create a vibrant and inclusive online community where artists of all backgrounds can showcase their creativity, share their stories, and find new audiences for their work. Whether you're a seasoned artist or a passionate art enthusiast, ArtZone provides a platform for you to explore, appreciate, and acquire unique pieces of art.
        <br>
        <br>
